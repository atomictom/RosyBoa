...
--
main = do
    print $ parseResult "99" anyChar
    print $ parseResult "apple" anyChar
    print $ parseResult "[test]" anyChar
    print $ parseResult "apple" (oneOf "abc")
    print $ parseResult "apple" (oneOf "xyz")
    print $ parseResult "__" (oneOf "_" )
    print $ parseResult "0" digit
    print $ parseResult "a0" digit
    print $ parseResult "10" digit
    print $ parseResult "99" digit
